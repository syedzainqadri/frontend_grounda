...
import 'package:frontend_grounda/views/pages/customer/customer_page_desktop.dart';
import 'package:frontend_grounda/views/pages/customer/customer_page_mobile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Scaffold(
        ...
        appBar: DashBoardAppBar(title: "Customer"),
            ...
            child: Container(
              ...
              child: const Padding(
                ...
                child: ResponsiveLayout(
                  desktopBody: CustomerPageDesktop(),
                  mobileBody: CustomerPageMobile(),
                ),
              ),
            ),
          ),
