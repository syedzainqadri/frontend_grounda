...
import 'package:frontend_grounda/views/pages/post/pending_post_page.dart';
...
class PendingPostView extends GetView<ThemeChangeController> {
  PendingPostView({super.key});
