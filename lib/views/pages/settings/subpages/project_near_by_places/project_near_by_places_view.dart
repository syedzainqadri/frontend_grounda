...
import 'package:frontend_grounda/views/pages/settings/subpages/project_near_by_places/project_near_by_places_desktop.dart';
import 'package:frontend_grounda/views/pages/settings/subpages/project_near_by_places/project_near_by_places_mobile.dart';
...
class ProjectNearByPlacesView extends GetView<SideBarController> {
  const ProjectNearByPlacesView({super.key});
          ...
          children: [
            ...
            Flexible(
              child: PageView(
                ...
                children: [
                  ResponsiveLayout(
                    desktopBody: ProjectNearByPlacesDesktop(),
                    mobileBody: ProjectNearByPlacesMobile(),
                  ),
                ],
              ),
            ),
