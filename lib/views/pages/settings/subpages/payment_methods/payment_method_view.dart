...
import 'package:frontend_grounda/views/pages/settings/subpages/payment_methods/payment_method_page_desktop.dart';
import 'package:frontend_grounda/views/pages/settings/subpages/payment_methods/payment_method_page_mobile.dart';
...
class PaymentMethodView extends GetView<SideBarController> {
          ...
          children: [
            ...
            Flexible(
              child: PageView(
                ...
                children: [
                  ResponsiveLayout(
                    desktopBody: PaymentMethodPageDesktop(),
                    mobileBody: PaymentMethodPageMobile(),
                  ),
                ],
              ),
            ),
