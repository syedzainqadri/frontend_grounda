...
import 'package:frontend_grounda/views/pages/settings/subpages/amenities/amenities_page_desktop.dart';
import 'package:frontend_grounda/views/pages/settings/subpages/amenities/amenities_page_mobile.dart';
...
class AmenitiesView extends GetView<SideBarController> {
          ...
          children: [
            ...
            Flexible(
              child: PageView(
                ...
                children: [
                  ResponsiveLayout(
                    desktopBody: AmenitiesPageDesktop(),
                    mobileBody: AmenitiesPageMobile(),
                  ),
                ],
              ),
            ),
